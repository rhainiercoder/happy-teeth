...
<main class="main">
  <div class="pDash">
    ...
    <section class="pGrid2">
      ...
      <!-- Clinic location (placeholder) -->
      <div class="pCard">
        <h3 class="pSectionTitle">Clinic Location</h3>
        <div class="pMapShape" aria-hidden="true"></div>
        <div style="margin-top:10px; font-weight:900; opacity:.75;">
          (Map placeholder — you can embed Google Maps later)
        </div>
      </div>
    </section>
